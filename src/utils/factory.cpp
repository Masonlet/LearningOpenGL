...
bool createTriangle(VAOManager* vaoManager, const std::string& name, const Vec2& size, const Vec4& vertexColour) {
	...
	info.vertices[0].pos = { -0.5f * size.x, -0.5f * size.y, 0.0f, 0.0f };
	info.vertices[1].pos = {  0.5f * size.x, -0.5f * size.y, 0.0f, 0.0f };
	info.vertices[2].pos = {  0.0f,           0.5f * size.y, 0.0f, 0.0f };
...
bool createSquare(VAOManager* vaoManager, const std::string& name, const Vec2& size) {
	...
	// First triangle
	info.vertices[0].pos = { -halfX, -halfY, 0.0f, 0.0f };
	info.vertices[1].pos = {  halfX, -halfY, 0.0f, 0.0f };
	info.vertices[2].pos = {  halfX,  halfY, 0.0f, 0.0f };

	// Second triangle
	info.vertices[3].pos = { -halfX, -halfY, 0.0f, 0.0f };
	info.vertices[4].pos = {  halfX,  halfY, 0.0f, 0.0f };
	info.vertices[5].pos = { -halfX,  halfY, 0.0f, 0.0f };
